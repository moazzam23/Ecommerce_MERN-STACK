...
if(MyCache.has(`myorder-${user}`)) orders= JSON.parse(MyCache.get(`myorder-${user}`)as string)
else{
...
if(MyCache.has("All-order")) orders= JSON.parse(MyCache.get("All-order")as string)
else{
