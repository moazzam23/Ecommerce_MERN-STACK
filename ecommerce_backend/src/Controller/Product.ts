...
import { NewProductgData, Searchtype, basequery } from "../Types/Types.js";
...
export  const Getlatestproduct = TryCatch(async(req,res,next)=>{ 
  ...
  let product;
  if(MyCache.has("Latest-products")) product= JSON.parse(MyCache.get("Latest-products")as string)
  else{
...
export  const Getproductcategory = TryCatch(async(req,res,next)=>{
  ...
  if (MyCache.has("Product-category")) product= JSON.parse(MyCache.get("Product-category")as string)
  else{
 ...
 export  const Getproductbyid = TryCatch(async(req,res,next)=>{
  ...
  if(MyCache.has(`products- ${id}`)) product= JSON.parse(MyCache.get(`products- ${id}`)as string)
  else{
...
export  const GetAllproductsearch = TryCatch(async(req:Request<{},{},{},Searchtype>,res,next)=>{
